...
#include "relaxParmMultiFit.h"

relaxParm relaxParmMultiFit::r1r2ParmOpt;
relaxParm relaxParmMultiFit::r1r2ParmOpt1;
relaxParm relaxParmMultiFit::r1r2ParmOpt2;

bool relaxParmMultiFit::isOptTauOvr;
bool relaxParmMultiFit::isOneTensor;
bool relaxParmMultiFit::isOptAngles;
bool relaxParmMultiFit::isOptTauInt;
bool relaxParmMultiFit::isOptAInt;

relaxParmMultiFit::relaxParmMultiFit(string inputFile)
{ 
...
relaxParmMultiFit::~relaxParmMultiFit()
{}

void relaxParmMultiFit::GAOptimization()
{
...
void relaxParmMultiFit::setFitRange(GARealAlleleSetArray & alleles)
{
...
void relaxParmMultiFit::initGAMethod(GASimpleGA & ga)
{
...
void relaxParmMultiFit::initPopulations(GASimpleGA & ga) 
{
...
void relaxParmMultiFit::printPopulations(ostream & outfile, GARealGenome & genome, const GASimpleGA & ga) 
{
...
void relaxParmMultiFit::writePopResults(ostream & outfile, GARealGenome & genome, const GASimpleGA & ga) 
{
...
void relaxParmMultiFit::calcRelaxParmFromGenome(relaxParm & r1r2Parm, const GARealGenome & a)
{
...
float relaxParmMultiFit::Objective(GAGenome& g)
{
...
float relaxParmMultiFit::Comparator(const GAGenome& g1, const GAGenome& g2) {
...
int main(int argc, char **argv)
{
  ...
  if(argc != 2)
    {
      ...
      cerr << " It should be 'relaxParmMultiFit ini_file'" << endl;
      return 0;
    }
  ...
  cout << "************************************************************************" << endl;
  relaxParmMultiFit R1R2Fit = relaxParmMultiFit(ini_file); 
