/***************************************************************************************  
 *   relaxParm2StateFit.h, header for relaxParm2StateFit.cpp to optimize relaxation    *
...
class relaxParm2StateFit 
{
  

 public:

  relaxParm2StateFit( string = "relaxParm2StateFit.inp");
  ~relaxParm2StateFit(); 
  ...
  static bool isOptPopA;                  // control the optimization of population A 
  double minPopA, maxPopA;                // minimum and maximum values of A population
 
 private:
  
  relaxParm r1r2ParmExp1,r1r2ParmExp2; 
  static relaxParm r1r2ParmOpt,r1r2ParmOpt1,r1r2ParmOpt2;
  double popAIni;                                          // initial population of A
  static double popA;                                      // current population of A
  ...
  void calcRelaxParmIni();                                     // calculate relax parameters from initial configuration
